...
def getSleep():
	...
	auth2_client = fitbit.Fitbit(CLIENT_ID, CLIENT_SECRET, oauth2=True, access_token=AccessToken, refresh_token=RefreshToken, redirect_uri=redirect_uri, timeout=10)
